...
[JsonConverter(typeof(CachedEntityConverter<MeshPhongMaterial>))]
...
__color = null;
        ...
        public Color specular
        {
            ...
            if(__specular == null)
            {
                __specular = EventHorizonBlazorInterop.GetClass<Color>(
                    this.___guid,
                    "specular",
                    (entity) =>
                    {
...
__envMap = null;
    ...
    #region Constructor
        ...
        public MeshPhongMaterial(
            MeshPhongMaterialParameters parameters = null
        ) : base()
        {
            var entity = EventHorizonBlazorInterop.New(
                new string[] { "MeshPhongMaterial" },
                parameters
            );
    ...
    #region Methods
        public void setValues(MeshPhongMaterialParameters parameters)
        {
