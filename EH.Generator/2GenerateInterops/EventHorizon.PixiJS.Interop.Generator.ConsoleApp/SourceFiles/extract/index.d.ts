...
import type { IRendererPlugin } from "./../core/index";
import { Rectangle } from "./../math/index";
import type { Renderer } from "./../core/index";
import { RenderTexture } from "./../core/index";
...
declare class Extract_2 implements IRendererPlugin {
     ...
     */
    static arrayPostDivide(pixels: number[] | Uint8Array | Uint8ClampedArray, outPixi: number[] | Uint8Array | Uint8ClampedArray): void;
}
